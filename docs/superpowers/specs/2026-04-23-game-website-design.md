...
```json
{
  "games": [
    ...
    },
    {
      "id": "gomoku",
      "name": "五子棋",
      "thumbnail": "assets/images/gomoku.png",
      "tags": ["益智", "AI对战"],
      "category": "puzzle",
    ...
    },
    {
      "id": "t2048",
      "name": "2048",
      "thumbnail": "assets/images/2048.png",
      "tags": ["益智", "数字"],
      "category": "puzzle",
    ...
    },
    {
      "id": "pinball",
      "name": "三维弹球",
      "thumbnail": "assets/images/pinball.png",
      "tags": ["街机", "弹球"],
      "category": "arcade",
...
**HTML：**
- `index.html` - 首页
- `games/minesweeper.html` - 扫雷
- `games/gomoku.html` - 五子棋
- `games/t2048.html` - 2048
- `games/snake.html` - 贪吃蛇
- `games/tetris.html` - 俄罗斯方块
- `games/pinball.html` - 三维弹球
...
- `js/common.js` - 公共模块
- `js/home.js` - 首页逻辑
- `js/games/minesweeper.js` - 扫雷
- `js/games/gomoku.js` - 五子棋
- `js/games/t2048.js` - 2048
- `js/games/snake.js` - 贪吃蛇
- `js/games/tetris.js` - 俄罗斯方块
- `js/games/pinball.js` - 三维弹球

**数据：**
- `data/games.json` - 游戏配置

**资源：**
- `assets/images/` - 游戏缩略图（6张）
- `assets/sounds/` - 音效文件（4个）
